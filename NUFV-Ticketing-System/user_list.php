    ...
    <div class="card card-outline">
        <div class="card-header">
            <div class="card-tools">
                <a href="index.php?page=new_user"><button class="btn btn-primary mr-1"><i class="fa fa-plus"></i>New User</button></a>
        ...
        <div class="card-body">
            <table class="table table-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT id, role, concat(lastname, ', ', firstname, ' ', middlename) as name, email FROM users WHERE role = 3 ORDER BY lastname, firstname ASC");
                    while ($row = $qry->fetch_assoc()):
                        $role_label = ($row['role'] == 3) ? 'User' : 'Admin';
                    ?>
                        <tr>
